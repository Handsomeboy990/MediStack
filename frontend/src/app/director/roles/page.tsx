...
const roles = [
  ...
  },
  {
    id: 'R-02',
    nom: 'Médecin',
    description: 'Consultation, prescription médicale, examens, bilans et préparation du brouillon de facture.',
    permissions: ['Tableau de bord médecin', 'Prescription médicale', 'Actes et bilans', 'Ordonnance patient', 'Transmission en caisse'],
    utilisateurs: 4,
  },
  {
    id: 'R-03',
